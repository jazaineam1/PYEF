...
2:{minutes:10,title:'Asociación no es comparación causal',objective:'Reconocer confusión y conocer herramientas para ajustar diferencias previas.',formula:'Y = β₀ + β₁T + β₂X + ε',methods:['Grafo causal (DAG)','Regresión ajustada','Puntaje de propensión','Ponderación por probabilidad inversa (IPW)'],teacher:[
...
4:{minutes:10,title:'Del efecto promedio a la política',objective:'Pasar del efecto promedio a heterogeneidad, impacto incremental y decisión segmentada.',formula:'CATE(x)=E[Y(1)−Y(0) | X=x]',methods:['Efecto por perfil (CATE)','Impacto incremental (uplift)','Bosques causales · visión general','Valor de política'],teacher:[
...
'Explica que bosques causales y otros meta-modelos pueden estimar heterogeneidad; no convierten mágicamente datos observacionales en causalidad sin supuestos.',
'Conecta el efecto por perfil con costo, capacidad y riesgo: la salida final es una política, no sólo un estimador.'
...
1:{business:'Define población, intervención, resultado y horizonte antes de escoger clientes.',data:'Interpreta el puntaje predictivo y explica qué sí predice y qué todavía no demuestra.',context:'Formula el contrafactual y pregunta qué tendría que ser comparable; aún no necesitas un DAG.',integrator:'Pregunta contra qué grupo compararías la intervención; aleatorización y efecto promedio se enseñarán después.',risk:'Activa tu Escudo de Riesgo: detecta desperdicio, daño posible o una decisión demasiado agresiva.'},
