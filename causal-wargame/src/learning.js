...
data:{label:'Líder de Modelos',tool:'Explorador de Uplift y CATE',purpose:'Separar puntaje predictivo, asociación y efecto incremental; en equipos incompletos puede cubrir temporalmente Experimentos.',color:'var(--blue)'},
context:{label:'Analista Causal',tool:'Laboratorio de Grafo Causal',purpose:'Construir y diagnosticar hipótesis causales: confusores, mediadores y colliders.',color:'var(--cyan)'},
...
4:{business:'Integra las cinco piezas y confirma que la política propuesta responde exactamente a la pregunta y respeta la restricción acordada.',data:'Usa el Explorador de Uplift y CATE: separa probabilidad base de cambio por intervención y compara estimadores sin tratarlos como magia.',context:'Usa el DAG para recordar que heterogeneidad sólo es causal si el efecto está identificado; evita mediadores/colliders problemáticos.',integrator:'Resume efecto e incertidumbre para que el equipo no sobrerreaccione a una estimación puntual.',risk:'Usa el Simulador de Política: asigna capacidad y presupuesto, controla riesgo y decide dónde intervenir, dónde no y dónde pedir más evidencia.'}
}
