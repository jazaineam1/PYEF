...
1:{
 business:[['scope_clear','La decisión debe fijar población, intervención, comparador, resultado y horizonte.'],['scope_missing','Todavía falta definir con precisión qué cambio queremos causar antes de analizar.']],
...
2:{
 business:[['redesign_first','No cerraría la decisión todavía: primero necesito una comparación defendible.'],['evidence_before_action','La diferencia cruda no alcanza para una decisión irreversible.']],
...
4:{
 business:[['policy_not_everyone','La decisión final debe responder el contrato causal original y la restricción acordada.'],['capacity_matters','Debo comprobar que la política propuesta no cambió silenciosamente población, outcome o restricción.']],
