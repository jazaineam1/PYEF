...
export const ROLES = [
  { code: 'business', label: 'Decision Lead', question: '¿Qué decisión necesitamos tomar?' },
  { code: 'data', label: 'Model Lead', question: '¿Qué dice el modelo y qué NO dice?' },
  { code: 'context', label: 'Causal Analyst', question: '¿Qué estructura causal hace válida o inválida la comparación?' },
  { code: 'risk', label: 'Policy & Risk Lead', question: '¿Dónde hay valor, costo o daño esperado?' },
  { code: 'integrator', label: 'Experiment Lead', question: '¿Qué diseño permite estimar un efecto defendible?' }
]
...
export const ROUND_COPY = {
  1:{kicker:'RONDA 1 · ORÁCULO',title:'El modelo sabe quién convertirá',mission:'Tienen presupuesto para intervenir sólo 10 de 24 clientes. Usen las herramientas del equipo y elijan a quiénes.',teaching:{title:'Debrief: predicción no es causalidad',body:'Un score alto responde “¿quién probablemente convertirá?”. La pregunta causal es “¿quién cambiará precisamente porque intervengo?”. El futuro que no observamos se llama contrafactual.'}},
  2:{kicker:'RONDA 2 · LA COMPARACIÓN ENGAÑOSA',title:'Las llamadas parecen empeorar el pago',mission:'Llamados pagan menos que no llamados. Usen las cinco herramientas para decidir si cancelar, mantener o rediseñar.',teaching:{title:'Debrief: una comparación puede ser injusta',body:'Si una característica previa influye tanto en quién recibe la llamada como en la probabilidad de pago, los grupos parten de lugares distintos. A esto lo llamamos confusión.'}},
  3:{kicker:'RONDA 3 · UNA PRUEBA MEJOR',title:'Necesitamos saber si realmente funciona',mission:'Hay 20.000 clientes elegibles. Diseñen cómo comparar intervención y no intervención, outcome y horizonte.',teaching:{title:'Debrief: el azar construye una comparación más creíble',body:'La randomización evita que el criterio de selección concentre sistemáticamente un tipo de cliente en un grupo. La diferencia de resultados puede interpretarse como un efecto promedio bajo el diseño del experimento.'}},
  4:{kicker:'RONDA 4 · EL PROMEDIO MIENTE',title:'Funciona… pero no para todos',mission:'El efecto promedio es positivo. Combinen CATE, valor y riesgo para construir una política.',teaching:{title:'Debrief: el efecto puede cambiar por perfil',body:'Un promedio positivo no significa que todos se beneficien. Cuando estudiamos cómo cambia el efecto por características hablamos de heterogeneidad; CATE es una forma de expresarlo.'}}
}
