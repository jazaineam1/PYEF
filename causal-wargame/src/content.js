...
export const ROLES = [
  ...
  { code: 'context', label: 'Analista Causal', question: '¿Qué hace válida o engañosa la comparación?' },
...
export const MICROCHECKS = {
  ...
  3:{prompt:'Tratamiento convierte 31% y control 25% en una asignación aleatoria. ¿Cuál es la diferencia?',options:['6 puntos porcentuales','6%','56 puntos porcentuales'],concept:'Efecto promedio'},
...
export const ROUND_COPY = {
  1:{kicker:'RONDA 1 · ORÁCULO',title:'El modelo sabe quién convertirá',mission:'Tienen presupuesto para intervenir sólo 10 de 24 clientes. Cada rol aporta una mirada básica; todavía no necesitan DAGs ni experimentos avanzados.',teaching:{title:'Cierre: predicción no es causalidad',body:'Un score alto responde “¿quién probablemente convertirá?”. La pregunta causal es “¿quién cambiará precisamente porque intervengo?”. El futuro que no observamos se llama contrafactual.'}},
  2:{kicker:'RONDA 2 · LA COMPARACIÓN ENGAÑOSA',title:'Las llamadas parecen empeorar el pago',mission:'Ahora que ya aprendieron DAG y confusión, aparecen nuevas capacidades. Úsenlas para decidir si cancelar, mantener o rediseñar.',teaching:{title:'Cierre: una comparación puede ser injusta',body:'Si una característica previa influye tanto en quién recibe la llamada como en la probabilidad de pago, los grupos parten de lugares distintos. A esto lo llamamos confusión.'}},
  3:{kicker:'RONDA 3 · UNA PRUEBA MEJOR',title:'Necesitamos saber si realmente funciona',mission:'Después de aprender randomización y efecto promedio, diseñen cómo comparar intervención y no intervención, resultado y horizonte.',teaching:{title:'Cierre: el azar construye una comparación más creíble',body:'La randomización evita que el criterio de selección concentre sistemáticamente un tipo de cliente en un grupo. La diferencia de resultados puede interpretarse como un efecto promedio bajo el diseño del experimento.'}},
  4:{kicker:'RONDA 4 · EL PROMEDIO NO CUENTA TODO',title:'Funciona… pero no para todos',mission:'Ahora se desbloquean uplift y ROI. Combinen heterogeneidad, valor y riesgo para construir una política.',teaching:{title:'Cierre: el efecto puede cambiar por perfil',body:'Un promedio positivo no significa que todos se beneficien. Cuando estudiamos cómo cambia el efecto por características hablamos de heterogeneidad; CATE es una forma de expresarlo.'}}
}
