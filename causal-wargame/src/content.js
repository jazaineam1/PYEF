...
export const ROLES = [
  { code: 'business', label: 'Estrategia y Política', question: '¿Qué decisión necesitamos tomar y bajo qué restricción?', core:true },
  { code: 'data', label: 'Líder de Modelos', question: '¿Qué dice el modelo y qué NO dice?', core:true },
  { code: 'context', label: 'Analista Causal', question: '¿Qué estructura causal hace válida o inválida la comparación?', core:true },
  { code: 'integrator', label: 'Líder de Experimentos', question: '¿Qué diseño permite estimar un efecto defendible?', core:true },
  { code: 'risk', label: 'Copiloto de Estrategia', question: '¿Qué costo, capacidad, daño o reversibilidad debemos revisar?', core:false, optional:true }
]
...
export const ROUND_COPY = {
  1:{kicker:'RONDA 1 · ORÁCULO',title:'El modelo sabe quién convertirá',mission:'Tienen presupuesto para intervenir sólo 10 de 24 clientes. Usen las cuatro responsabilidades del equipo y elijan a quiénes.',teaching:{title:'Cierre: predecir no es causar',body:'Un puntaje alto responde “¿quién probablemente convertirá?”. La pregunta causal es “¿quién cambiará precisamente porque intervengo?”. El futuro que no observamos se llama contrafactual.'}},
  2:{kicker:'RONDA 2 · LA COMPARACIÓN ENGAÑOSA',title:'Las llamadas parecen empeorar el pago',mission:'Llamados pagan menos que no llamados. Usen las cuatro responsabilidades para decidir si cancelar, mantener o rediseñar.',teaching:{title:'Cierre: una comparación puede ser injusta',body:'Si una característica previa influye tanto en quién recibe la llamada como en la probabilidad de pago, los grupos parten de lugares distintos. A esto lo llamamos confusión.'}},
  ...
  4:{kicker:'RONDA 4 · EL PROMEDIO NO CUENTA TODA LA HISTORIA',title:'Funciona… pero no para todos',mission:'El efecto promedio es positivo. Combinen efecto por segmento, valor y riesgo para construir una política bajo la restricción acordada.',teaching:{title:'Cierre: el efecto puede cambiar por perfil',body:'Un promedio positivo no significa que todos se beneficien. Cuando estudiamos cómo cambia el efecto por características hablamos de heterogeneidad; CATE es una forma de expresarlo.'}}
}
