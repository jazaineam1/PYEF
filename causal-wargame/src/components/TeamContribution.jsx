...
const DEPENDENCIES={
  business:{needs:['data','context','integrator','risk'],text:'Tu cierre necesita estimación, identificación, incertidumbre y una política factible. Define primero el contrato y vuelve a él cuando lleguen las otras cuatro piezas.'},
  ...
  risk:{needs:['business','data','context','integrator'],text:'Tu política necesita saber qué se estima, bajo qué identificación, con qué incertidumbre y bajo qué restricción de negocio.'}
}
