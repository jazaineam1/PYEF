...
import{assessWarRoom}from'../causal-integration'
...
export function TeamContribution({state,evidence}){
  ...
  const integration=useMemo(()=>assessWarRoom(data?.rows||[],round),[data?.rows,round])
