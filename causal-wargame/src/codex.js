...
export const ROLE_ARCHETYPES={
  ...
  data:{label:'Líder de Modelos',family:'Modelos',type:'SEÑAL',emoji:'🦉',accent:'#43b7ff',tagline:'Separa predicción de oportunidad de intervención.',tool:'Explorador de Modelos',mission:'En R1 interpreta el puntaje predictivo y dice qué NO demuestra. Las herramientas causales del rol aparecen sólo después de ser enseñadas.',powers:[{name:'Radar de Propensión',unlockRound:2,why:'Analiza la probabilidad de recibir el tratamiento dadas características previas; ayuda a diagnosticar comparabilidad.'},{name:'Lente de Impacto Incremental',unlockRound:4,why:'Compara probabilidad base con cuánto cambia el resultado por la intervención (uplift).'}]},
  context:{label:'Analista Causal',family:'Causalidad',type:'CAUSAL',emoji:'🐈‍⬛',accent:'#b56cff',tagline:'Busca qué hace válida o engañosa una comparación.',tool:'Laboratorio de Grafo Causal',mission:'En R1 formula el contrafactual. Desde R2, después de aprender DAG y confusión, representa la estructura causal.',powers:[{name:'Visión de Grafo Causal (DAG)',unlockRound:2,why:'Representa relaciones causales después de aprender qué es un DAG.'},{name:'Escáner de Confusión',unlockRound:2,why:'Busca variables previas que afectan tratamiento y resultado.'}]},
  integrator:{label:'Líder de Experimentos',family:'Experimentación',type:'EVIDENCIA',emoji:'🐢',accent:'#44dfa8',tagline:'Diseña comparaciones que soporten una conclusión.',tool:'Laboratorio de Experimentos',mission:'Antes de R3 revisa qué comparación sería justa. Aleatorización y efecto promedio aparecen sólo después de enseñarlos.',powers:[{name:'Escudo de Aleatorización (RCT)',unlockRound:3,why:'Usa asignación aleatoria cuando el diseño lo permite.'},{name:'Medidor de Efecto Promedio (ATE)',unlockRound:3,why:'Interpreta magnitud e incertidumbre del efecto promedio.'}]},
  risk:{label:'Política y Riesgo',family:'Política',type:'POLÍTICA',emoji:'🦅',accent:'#ff6f75',tagline:'Evita convertir un efecto en una mala política.',tool:'Simulador de Política',mission:'Desde R1 revisa costo, capacidad y daño. La herramienta de valor aparece cuando ya se enseñó heterogeneidad.',powers:[{name:'Escudo de Riesgo',unlockRound:1,why:'Frena decisiones con daño o desperdicio evidente.'},{name:'Forja de Valor (ROI)',unlockRound:4,why:'Convierte efecto, volumen y costo en valor de política.'}]}
}
